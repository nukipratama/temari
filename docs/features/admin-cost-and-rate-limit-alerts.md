...
| Per-athlete ceiling trip | [`AnalysisService::ceilingExceeded()`](../../app/Services/AI/AnalysisService.php#L873) | `Cache::add` on a date-and-athlete key: once per athlete per day, not once per gated dispatch |
