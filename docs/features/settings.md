...
- **Your data** — the plain-language data-use statement, server-supplied from [DataUseStatement](../../app/Support/DataUseStatement.php) so the page and the later terms/privacy pages cannot word it differently. Why it says what it says: [[strava-data-compliance]].
