...
| **Plan** | [[plan-volume-anchors-on-weekly-mean]] (prescribed volume describes the athlete, not their biggest day); [[today-credits-when-earned]] (a day in progress is graded upward only, and the ring counts the days the week holds); [[readiness-clamp-is-advisory]] (the clamp eases today beside the plan, it does not replace it); [[a-session-is-the-whole-outing]] (a day's distance covers everything it asks you to run, and no cooldown is prescribed) |
