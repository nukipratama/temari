...
| **Notifications** | [[inbox-is-an-always-on-channel]] (the inbox as an unmuteable third channel); [[demo-notifications-are-inbox-only]] (demo routed to the record, never to an interruption); [[the-briefing-arrives-when-you-run]] (the morning push lands at the athlete's own median start time, and generates nothing) |
