...
Claim and settle fencing is implemented in `app/Services/Notifications/NotificationDeliveryClaim.php:31` and `app/Services/Notifications/NotificationDeliveryClaim.php:69`; both channel wrappers pass the version at `app/Notifications/Channels/TelegramChannel.php:90` and `app/Notifications/Channels/IdempotentWebPushChannel.php:73`. The scheduled sweep is registered at `routes/console.php:159`, and the operator signal is rendered at `app/Livewire/Pulse/NotificationDeliveryHealth.php:28`.
