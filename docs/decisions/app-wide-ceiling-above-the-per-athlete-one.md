...
[`ceilingExceeded()`](app/Services/AI/AnalysisService.php#L895) helper. Sharing the path is the point: what "past the ceiling" *does* can never diverge between the two. So
...
([`shouldServeRuleBased()`](app/Services/AI/AnalysisService.php#L665)) so it is
