...
Done, funnelled through [`markDone()`](app/Services/AI/AnalysisService.php#L280): `llm` by
default, `rule_based` from
[`fillRuleBased()`](app/Services/AI/AnalysisService.php#L1006) (demo seed, demo triggers, the
...
and `generated_at` in
[`archivePreviousVersion()`](app/Services/AI/AnalysisService.php#L404), on the same transition as
