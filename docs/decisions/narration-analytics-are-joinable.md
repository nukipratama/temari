...
[`fillRuleBased()`](app/Services/AI/AnalysisService.php#L1072) (demo seed, demo triggers, the
...
and `generated_at` in
[`archivePreviousVersion()`](app/Services/AI/AnalysisService.php#L461), on the same transition as
