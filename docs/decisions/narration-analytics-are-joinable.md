...
[`fillRuleBased()`](app/Services/AI/AnalysisService.php#L830) (demo seed, demo triggers, the
...
and `generated_at` in
[`archivePreviousVersion()`](app/Services/AI/AnalysisService.php#L294), on the same transition as
