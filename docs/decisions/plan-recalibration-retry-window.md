...
The job’s [retry deadline](app/Jobs/Run/RecalibrateTrainingHistoryJob.php#L40) is ten minutes, and its [exception cap](app/Jobs/Run/RecalibrateTrainingHistoryJob.php#L20) limits genuine failures to three. A [lock-contention release](app/Jobs/Run/RecalibrateTrainingHistoryJob.php#L75) does not spend that cap. With a [120-second execution timeout](app/Jobs/Run/RecalibrateTrainingHistoryJob.php#L27) and [Redis retry-after of 420 seconds](config/queue.php#L74), a consistently timed-out history gets about two executions before the deadline. The recalculation remains atomic, and issue #1249 tracks the resumable follow-up.
