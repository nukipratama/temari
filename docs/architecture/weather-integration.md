...
- **[[dashboard]]** — the last-run weather chip on [LastLariCard](resources/js/components/dashboard/LastLariCard.tsx#L24) and [TemariVoiceCard](resources/js/components/dashboard/TemariVoiceCard.tsx#L58), both via the `formatWeather` helper.
