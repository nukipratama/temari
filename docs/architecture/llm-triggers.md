...
[`blockingReason()`](../../app/Services/AI/AnalysisService.php#L1046), and an in-flight job reverts
...
[`degradeToRuleBased()`](../../app/Services/AI/AnalysisService.php#L1100), so a capped day is not a
...
because [`generationPaused()`](../../app/Services/AI/AnalysisService.php#L1011) asks with the budget
...
- **Demo exclusion.** [`notDemo()`](../../app/Models/User.php#L120) filters the AI kickoff commands
  ...
  [`shouldServeRuleBased()`](../../app/Services/AI/AnalysisService.php#L962) serves a demo user's
