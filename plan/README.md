...
| S2 | Onboarding | 2b | [14](slices/14-S2-onboarding.md) | in-review | [#672](https://github.com/nukipratama/temari/pull/672) | wt | 95.62→95.68% stmts | preferences restructured into a per-question sub-stepper (StepProgress/IconChoiceCard/SessionsDial/DayPicker), no backend fork |
