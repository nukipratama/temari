...
| W7 | LLM trigger map | 3 | [33](slices/33-W7-llm-trigger-map.md) | todo | — | main | n/a | **added 2026-09-02 at the user's request** — one document answering "what makes this app call an LLM, and when". Docs-only; a wrong or over-firing trigger found is a finding, not an inline fix. See §5 |
