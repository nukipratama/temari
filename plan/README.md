...
| S7 | History | 2b | [19](slices/19-S7-history.md) | in-review | [#675](https://github.com/nukipratama/temari/pull/675) | wt | 95.56% stmts, 89.39% branches, 95.46% fn, 95.97% lines | feed filters + journey strip cut per ledger (also orphaned ActiveFilterChips/ResumeFilterChip/useLastFilter/Calendar mood filter); RecapCard unifies weekly+monthly recap chrome, compact RunListRow, load-older-weeks reveal |
