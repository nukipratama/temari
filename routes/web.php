...
// One-tap demo login. Generated by `php artisan demo:login` as a signed
// URL with a 24h TTL — no UI link, gated to local/testing envs at request
// time so production traffic 404s even if the route is reachable.
Route::get('/dev/login-as-demo/{user}', function (Request $request, User $user) {
