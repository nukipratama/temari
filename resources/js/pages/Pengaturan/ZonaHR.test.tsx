...
describe('ZonaHR', () => {
    ...
    it('loads the zone table from saved data, not an auto-calc', () => {
        ...
        expect(
            (screen.getByTestId('zone-Z2-lo') as HTMLInputElement).value,
        ).toBe('141');
    ...
    it('surfaces a server field error under the input', () => {
        ...
        expect(maxHrInput.getAttribute('aria-describedby')).toBe(
    ...
    it('lets the user override a manual hi boundary', () => {
        ...
        expect(
            (screen.getByTestId('zone-Z2-hi') as HTMLInputElement).value,
        ).toBe('150');
    });
    ...
    it('recomputes manual zones from Max & Resting on demand', () => {
        ...
        expect(
            (screen.getByTestId('zone-Z2-lo') as HTMLInputElement).value,
        ).toBe(String(deriveZones(180, 55).Z2.lo));
    });
