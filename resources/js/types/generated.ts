...
export type NotificationKind = 'post_run' | 'weekly_recap' | 'monthly_recap' | 'streak_reminder' | 'plan_clamp' | 'strava_disconnected' | 'test';
export const NOTIFICATION_KIND_VALUES = ['post_run', 'weekly_recap', 'monthly_recap', 'streak_reminder', 'plan_clamp', 'strava_disconnected', 'test'] as const;
