...
export type AnalysisType = 'briefing_mascot_voice' | 'post_run_speech' | 'run_insight' | 'weekly_recap' | 'card_flavor' | 'profile_voice' | 'monthly_recap' | 'trend_read' | 'plan_day_voice' | 'plan_clamp_voice' | 'plan_season_voice';
export const ANALYSIS_TYPE_VALUES = ['briefing_mascot_voice', 'post_run_speech', 'run_insight', 'weekly_recap', 'card_flavor', 'profile_voice', 'monthly_recap', 'trend_read', 'plan_day_voice', 'plan_clamp_voice', 'plan_season_voice'] as const;
