...
const COLUMNS = ['Jenis', 'Panggilan', 'Prompt', 'Completion', 'Total', 'Biaya', 'Latency (avg/max)', 'Terpotong'];
...
export default function KindTable({
    ...
    return (
        <DataTable
            ...
            renderRow={(row) => <KindCells row={row} grandTotal={grandTotal} currency={currency} />}
        />
    );
}
