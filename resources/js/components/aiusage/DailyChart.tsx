...
import { fmt, formatCost, formatDayLabel, formatDayLabelShort } from '@/pages/AiUsage/helpers';
import type { DailyRow } from '@/pages/AiUsage/types';

export default function DailyChart({ data, currency }: Readonly<{ data: DailyRow[]; currency: string }>) {
