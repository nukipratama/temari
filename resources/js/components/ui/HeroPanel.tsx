...
const GRADIENT =
    'bg-[linear-gradient(160deg,var(--color-sky-deep)_0%,var(--color-sky)_60%,var(--color-sky-2)_100%)]';
...
const STARS: StarDot[] = [
    ...
    [
        2, 4, 8, 12, 16, 20, 24, 28, 33, 38, 42, 47, 52, 56, 60, 64, 68, 72, 76,
        80, 84, 88, 92, 96,
    ].map((x, i) => ({
        x: x + (i % 3),
        y: 2 + (i % 5) * 0.7,
    ...
    [
        3, 7, 13, 18, 23, 28, 33, 38, 43, 48, 53, 58, 63, 68, 73, 78, 83, 88,
        93, 97,
    ].map((x, i) => ({
        x: x + (i % 3),
        y: 10 + (i % 5) * 0.6,
...
export default function HeroPanel({
    ...
    return (
        <div
            className={cn(
                'relative rounded-lg px-6 py-6 text-cream',
