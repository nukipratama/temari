...
export default function Eyebrow({ as, token, tone, className, children }: Readonly<EyebrowProps>) {
    const Tag = (as ?? 'div') as ElementType;
    return <Tag className={cn(eyebrowVariants({ token, tone }), className)}>{children}</Tag>;
}
