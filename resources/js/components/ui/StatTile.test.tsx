...
describe('StatTile', () => {
    ...
    it.each([
        ...
        'renders tone %s with its tone-specific class',
        (tone, expected) => {
    ...
    it('applies on-sky text tokens for sky tones', () => {
        const { container } = render(
            <StatTile value="x" label="y" tone="plainSky" />,
        );
    ...
    it('renders a leading dot from dotClass', () => {
        const { container } = render(
            <StatTile value="x" label="y" dotClass="bg-horizon" />,
        );
    ...
    it('centers the stack when align=center', () => {
        const { container } = render(
            <StatTile value="x" label="y" align="center" />,
        );
