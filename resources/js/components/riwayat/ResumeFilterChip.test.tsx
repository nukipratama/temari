...
describe('ResumeFilterChip', () => {
    it('names what resuming would apply', () => {
        render(<ResumeFilterChip summary="Half ke atas · Nyala" onResume={vi.fn()} onDismiss={vi.fn()} />);
    ...
    it('can be dismissed so it cannot nag', () => {
        ...
        render(<ResumeFilterChip summary="Nyala" onResume={vi.fn()} onDismiss={onDismiss} />);
