...
it('caps at the most restrictive guardrail', function (
    ...
    'high monotony caps at easy even when fresh' => ['fresh', 60, false, 2.5, 0.0, 'up', ReadinessCeiling::EasyOnly],
    'under-24h recovery caps at easy' => ['fresh', 12, false, 1.0, 0.0, 'up', ReadinessCeiling::EasyOnly],
    ...
    '24-48h recovery withholds quality' => ['fresh', 36, false, 1.0, 0.0, 'up', ReadinessCeiling::ModerateOk],
