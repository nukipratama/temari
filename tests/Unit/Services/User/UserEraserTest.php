...
function analysesForEverySubjectShape(User $user): void
{
    ...
    foreach ([
        ...
        [AnalysisType::BRIEFING_SUBJECT_TYPE, $user->id, AnalysisType::BriefingHeadline],
        [AnalysisType::DAILY_GREETING_SUBJECT_TYPE, $user->id, AnalysisType::DailyGreeting],
        [AnalysisType::TREND_CAPTION_SUBJECT_TYPE, $user->id, AnalysisType::TrendCaption],
