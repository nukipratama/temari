...
const NON_BILLING = [
    ...
    'model:prune' => 'deletes telemetry rows, touches no user',
    ...
    'ai:spend-digest' => 'reads today\'s ai_token_usages rows and pushes one maintainer summary, no LLM and no Strava call',
